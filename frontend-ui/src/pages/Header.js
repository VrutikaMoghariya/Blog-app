                ...
                <Form >
                  <div className="input-group">
                    <div className="input-group-prepend">
                      <button id="button-addon2" type="submit" className="btn btn-link text-dark "><FiSearch /></button>
                    </div>
                    <input type="search" placeholder="Search Posts, tags & authors" aria-describedby="button-addon2" className="form-control border-0 " />
                  </div>
                </Form>
              </Modal.Body>
            </Modal>
